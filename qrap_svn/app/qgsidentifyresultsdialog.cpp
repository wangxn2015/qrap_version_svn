...
//QgsIdentifyResultsDialog::QgsIdentifyResultsDialog( QgisApp *QGisApp, QgsMapCanvas *canvas, QWidget *parent, Qt::WindowFlags f )

QgsIdentifyResultsDialog::QgsIdentifyResultsDialog( QWidget *QGisApp, QgsMapCanvas *canvas, QWidget *parent, Qt::WindowFlags f )
    : QDialog( parent, f )
...
{
  connect( this, SIGNAL( activateLayer( QgsMapLayer * ) ), mQGisApp, SLOT( setActiveLayer( QgsMapLayer * ) ) );
  emit activateLayer( layer( lstResults->currentItem() ) );
  disconnect( this, SIGNAL( activateLayer( QgsMapLayer * ) ), mQGisApp, SLOT( setActiveLayer( QgsMapLayer * ) ) );
}
