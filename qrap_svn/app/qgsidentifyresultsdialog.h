...
//    QgsIdentifyResultsDialog( QgisApp *QGisApp, QgsMapCanvas *canvas, QWidget *parent = nullptr, Qt::WindowFlags f = nullptr );
    QgsIdentifyResultsDialog( QWidget *QGisApp, QgsMapCanvas *canvas, QWidget *parent = nullptr, Qt::WindowFlags f = nullptr );
